...
def setup_otel_logging() -> None:
    ...
    try:
        from opentelemetry.exporter.otlp.proto.http._log_exporter import \
            OTLPLogExporter  # noqa: I001
        from opentelemetry.sdk._logs import (LoggerProvider,  # noqa: I001
                                             LoggingHandler)
        from opentelemetry.sdk._logs.export import \
            BatchLogRecordProcessor  # noqa: I001
        from opentelemetry.sdk.resources import (SERVICE_NAME,  # noqa: I001
                                                 Resource)
    ...
    root.setLevel(
        getattr(logging, os.getenv("OTEL_LOG_LEVEL", "INFO").upper(), logging.INFO)
    )
